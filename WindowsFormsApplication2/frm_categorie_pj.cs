...
{
    public partial class frm_categorie_pj : Form
    {
        public frm_categorie_pj()
        {
            InitializeComponent();
        }
        Sqlcon c = new Sqlcon();
        ...
        public void refresh_dgv()
        {
            try
            {
                SqlCommand cmd = new SqlCommand("select * from Cat_pj");
        ...
        public void add_cat()
        {
            try
            {
                SqlCommand cmd = new SqlCommand("insert into Cat_pj values ('" + textBox2.Text + "')");
                cmd.Connection = c.cnx;
                cmd.ExecuteNonQuery();
                refresh_dgv();
            }
        ...
        public void remove_cat()
        {
            ...
            SqlCommand cmd = new SqlCommand("delete from Cat_pj where idcodepj = '" + id + "'", c.cnx);
            cmd.ExecuteNonQuery();
            refresh_dgv();
            // }catch { }
        ...
        public void edit_cat()
        {
            ...
            {
                int id = (int)dataGridView1.Rows[i].Cells[0].Value;
                SqlCommand cmd = new SqlCommand("update Cat_pj set intitule = '" + textBox2.Text + "' where idcodepj =  '" + id + "'", c.cnx);
                cmd.ExecuteNonQuery();
                refresh_dgv();
            }
            catch { }
