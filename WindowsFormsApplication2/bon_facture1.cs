...
{
    public partial class bon_facture1 : Form
    {
        public bon_facture1()
        {
            InitializeComponent();
        ...
        private void valider()
        {
            try
            {
                bon_facture bn = new bon_facture();
                ...
                dc.bon_factures.InsertOnSubmit(bn);
                dc.SubmitChanges();
                valid = true;
                this.Close();
            }
        ...
        private void Frm_bcfrs_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                int count = 0;
                SqlCommand cmd = new SqlCommand("select * from bon_facture ", c.cnx);
