...
{
    public partial class form_labo : Form
    {
        public form_labo()
        {
            InitializeComponent();
        ...
        public void edit_post()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand(" update Labo set Intitulé ='" + txt_intitile.Text + "' , Adresse ='" + txt_adress.Text + "' , Telepohne ='" + txt_tel.Text + "' , Fix ='" + txt_fix.Text + "' , Email ='" + txt_email.Text + "' , website ='" + txt_siteweb.Text + "' where Idlabo = '" + id + "'", c.cnx);
                cmd.ExecuteNonQuery();
                refresh_dgv();
            }
            catch { }
        ...
        public void refresh_dgv()
        {
            try
            {
                SqlCommand cmd = new SqlCommand("select * from Labo");
        ...
        public void add_arch()
        {
            try
            {
                SqlCommand cmd = new SqlCommand(" insert into Labo values ('" + txt_intitile.Text + "','" + txt_adress.Text + "','" + txt_tel.Text + "','" + txt_fix.Text + "','" + txt_email.Text + "','" + txt_siteweb.Text + "')");
                cmd.Connection = c.cnx;
                cmd.ExecuteNonQuery();
                refresh_dgv();
            }
        ...
        public void remove_post()
        {
            ...
            {
                int id = (int)dataGridView1.Rows[i].Cells[0].Value;
                SqlCommand cmd = new SqlCommand("delete from Labo where Idlabo = '" + id + "'", c.cnx);
                cmd.ExecuteNonQuery();
                refresh_dgv();
            }
            catch { }
